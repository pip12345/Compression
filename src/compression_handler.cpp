...
std::string compression::Compression_handler::remove_txt_extension(const std::string& file_name) {
...
void compression::Compression_handler::huff_compress(const std::string& file_name) {
...
void compression::Compression_handler::huff_decompress(const std::string &file_name) {
    std::string file_no_extension = remove_txt_extension(file_name);
...
void compression::Compression_handler::lzw_compress(const std::string &file_name) {
    std::string file_no_extension = remove_txt_extension(file_name);

    file.write_bits(file_no_extension + lzw_extension_compressed, lzwcoder.encode(file.open(file_no_extension + ".txt")));
}

void compression::Compression_handler::lzw_decompress(const std::string &file_name) {
    std::string file_no_extension = remove_txt_extension(file_name);
